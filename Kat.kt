...
val name_animals = mutableListOf("camel", "lion", "deer", "goose", "bat", "rabbit")
fun main() {
    while (true) {
        for (i in 0..5) {
            println("${i+1}. ${name_animals[i]}")
        }
        println("if you want to finish, you can write \"exit\"")
        print("Please enter the number of the habitat you would like to view: ")
        val a = readLine()!!
        if (a != "exit") {
            println()
            println(animals[a.toInt() - 1])
        } else break
    }
